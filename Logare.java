		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (id != null) {
					...
					switch (rol) {
					case 1: {
						PaginaPrincipalaStudent user = new PaginaPrincipalaStudent(x, y, nume[0], nume[1], con);
						break;
					}
					case 2: {
						PaginaPrincipalaProfesor user = new PaginaPrincipalaProfesor(x, y, nume[0], nume[1], con);
						break;
					}
					case 3: {
